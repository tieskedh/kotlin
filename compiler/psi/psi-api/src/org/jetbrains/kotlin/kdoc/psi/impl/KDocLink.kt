 ...
 *
 * It appears either as the [subject][KDocTag.getSubjectLink] of a block tag or as an inline link within the
 * documentation text.
 *
 * ### Example:
 *
...
class KDocLink(node: ASTNode) : KtElementImpl(node) {
    ...
    /**
     * Returns the range of the [link text][getLinkText] within this element, excluding the enclosing square brackets
     * if they are present.
     */
