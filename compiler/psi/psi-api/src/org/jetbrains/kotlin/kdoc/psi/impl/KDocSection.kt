...
class KDocSection(node: ASTNode) : KDocTag(node), ContributedReferenceHost, PsiLanguageInjectionHost {
    ...
    /**
     * Returns all tags in this section whose [name][KDocTag.getName] equals the given [name] (without the leading
     * `@`), in source order.
     */
    ...
    /**
     * Returns the first tag in this section whose [name][KDocTag.getName] equals the given [name] (without the leading
