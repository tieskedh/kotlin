...
class BackendWasmSymbols(
    ...
    val coroutineImplId =
        if (!configuration.wasmUseStackSwitchingProposal)
            ...
            ClassIds.coroutineImplStackSwitching

    override val coroutineImpl = coroutineImplId.classSymbol()
...
private object ClassIds {
    ...
    // coroutines
    val coroutineImplStateMachine = "CoroutineImplStateMachine".coroutinesClassId
