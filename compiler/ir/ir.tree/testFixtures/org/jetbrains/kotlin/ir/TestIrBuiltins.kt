...
object TestIrBuiltins : IrBuiltIns() {
    ...
    private val builtinsPackage = IrExternalPackageFragmentImpl(IrExternalPackageFragmentSymbolImpl(), FqName("kotlin"), IrModuleFragmentImpl(ErrorModuleDescriptor))
