...
| annotation-associated and other reflection operations | valued construction, defaults, KLIB applications, and exact fail-closed CLR projection | reflection discovery and target-specific association policy |
