...
class DotNetClrCustomAttributeNamedArgumentValidator(
    ...
    private fun matchesPrimitive(
        ...
        return actual.type.hasSameIdentityAs(primitiveType) &&
                actual.isValueType == primitive.isClrValueType
    }
...
private val DotNetClrPrimitiveType.metadataName: String
    get() =
        when (this) {
...
private val DotNetClrPrimitiveType.isClrValueType: Boolean
