...
internal object DotNetGenericInterfaceRuntime {
         ...
         extends ${coreLibraryReference}System.Object
  {
        ...
        $entryType 'next') cil managed
    {
      ...
      ldarg.0
      ldarg.3
      stfld int32 Kotlin.Runtime.Internal.GenericInterfaceProducerDispatchEntry::'argumentCount'
      ldarg.0
         ...
         extends ${coreLibraryReference}System.Object
  {
    ...
    .method private hidebysig static bool 'IsCompatibleContravariantOpenNullableView'(
        ...
        $typeType 'requestedDefinition',
        $typeType 'expectedCapability') cil managed
    {
      .maxstack 3
      .locals init (
        [0] $typeType[] 'requestedParameters',
        [1] $typeType[] 'requestedArguments',
        [2] $typeType 'markerDefinition',
        [3] int32 'index',
        [4] $typeType 'candidate',
        [5] $typeType[] 'markerArguments',
      ...
      brfalse GIF_OpenNullableFalse
      ldarg.3
      callvirt instance bool ${coreLibraryReference}System.Type::get_IsInterface()
      brfalse GIF_OpenNullableFalse
      ldarg.3
      callvirt instance $typeType[] ${coreLibraryReference}System.Type::GetGenericArguments()
      stloc.0
      ...
      ldc.i4.0
      stloc.3
    GIF_OpenNullableNext:
      ldloc.3
      ldarg.1
      ldlen
      conv.i4
      bge GIF_OpenNullableFalse
      ldarg.1
      ldloc.3
      ldelem.ref
      stloc.s 4
      ldloc.s 4
      callvirt instance bool ${coreLibraryReference}System.Type::get_IsGenericType()
      brfalse GIF_OpenNullableContinue
      ldloc.s 4
      callvirt instance $typeType ${coreLibraryReference}System.Type::GetGenericTypeDefinition()
      ldloc.2
      call bool ${coreLibraryReference}System.Type::op_Equality($typeType, $typeType)
      ...
      conv.i4
      ldc.i4.1
      bne.un GIF_OpenNullableContinue
      ldloc.s 5
      ldc.i4.0
      ldelem.ref
      stloc.s 6
      ...
      brtrue GIF_OpenNullableContinue
      ldloc.s 8
    ...
    GIF_OpenNullableValueWitness:
      ...
      call bool ${coreLibraryReference}System.Type::op_Equality($typeType, $typeType)
      brtrue.s GIF_OpenNullableTrue
    GIF_OpenNullableContinue:
      ldloc.3
      ldc.i4.1
      add
      stloc.3
      br GIF_OpenNullableNext
    GIF_OpenNullableTrue:
      ldc.i4.1
      ret
    GIF_OpenNullableFalse:
      ldc.i4.0
      ret
    }
    ...
    GIF_CompatibleNext:
      ...
      ldlen
      conv.i4
      bge GIF_CompatibleOpenNullable
      ldloc.0
      ldloc.1
      ldelem.ref
      stloc.2
    ...
    GIF_InstanceReady:
      ldarg.3
      brtrue.s GIF_ArgumentsPresent
      ldc.i4.0
      br.s GIF_ArgumentCountReady
    GIF_ArgumentsPresent:
      ldarg.3
      ldlen
      conv.i4
    GIF_ArgumentCountReady:
      stloc.s 12
      ldarg.0
      callvirt instance $typeType ${coreLibraryReference}System.Object::GetType()
      stloc.s 7
    ...
    GIF_MethodSearchArityReady:
      ...
      newobj instance void ${coreLibraryReference}System.InvalidOperationException::.ctor(string)
      throw
    GIF_MethodSearchSelect:
      ldloc.s 15
      stloc.s 4
    GIF_MethodSearchContinue:
      ldloc.s 14
      ldc.i4.1
      add
      stloc.s 14
    ...
    .method public hidebysig static object 'InvokeUniqueTypeArgumentUnaryMemberWithBarrier'(
        object 'instance',
        $typeType 'openDefinition',
        string 'methodName',
        object[] 'arguments',
    ...
    fun invokeUniqueTypeArgumentUnaryMemberWithBarrierCallInstruction(
        coreLibraryReference: String,
    ): String =
        "call object [${DotNetRuntimeLibrary.ASSEMBLY_NAME}]" +
                "${"Kotlin.Runtime.Internal.GenericInterfaceDispatch".toIlIdentifier()}::" +
