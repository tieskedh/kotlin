 ...
 * modules, including the constructor-default ABI marker and optional ExactFunctionN execution
 * capabilities, lives below the reserved `Kotlin.Runtime.Internal` namespace.
