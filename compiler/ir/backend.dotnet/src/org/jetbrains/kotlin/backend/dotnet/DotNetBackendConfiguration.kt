...
object DotNetBackendConfigurationKeys {
...
val CompilerConfiguration.dotNetProducedLibraryArtifact: DotNetLibraryArtifact?
    get() = when {
        dotNetProducesStdlib -> DotNetLibraryArtifact(
            ...
            targetFramework = dotNetTarget.description,
        ...
        dotNetProducesLibrary -> dotNetAssemblyName?.let { assemblyName ->
            DotNetLibraryArtifact(assemblyName, dotNetTarget.description)
        }
        else -> null
    }

var CompilerConfiguration.dotNetExports: List<DotNetExport>
    get() = get(DotNetBackendConfigurationKeys.EXPORTS, emptyList())
    set(value) {
        put(DotNetBackendConfigurationKeys.EXPORTS, value)
    }

var CompilerConfiguration.dotNetPropertyExports: List<DotNetPropertyExport>
    get() = get(DotNetBackendConfigurationKeys.PROPERTY_EXPORTS, emptyList())
    set(value) {
        put(DotNetBackendConfigurationKeys.PROPERTY_EXPORTS, value)
    }

var CompilerConfiguration.dotNetExternalStdlib: DotNetExternalStdlib?
    get() = get(DotNetBackendConfigurationKeys.EXTERNAL_STDLIB)
    set(value) {
        if (value != null) {
            put(DotNetBackendConfigurationKeys.EXTERNAL_STDLIB, value)
        }
    }

var CompilerConfiguration.dotNetExternalLibraries: List<DotNetExternalLibrary>
    get() = get(DotNetBackendConfigurationKeys.EXTERNAL_LIBRARIES, emptyList())
    set(value) {
        put(DotNetBackendConfigurationKeys.EXTERNAL_LIBRARIES, value)
    }

var CompilerConfiguration.dotNetExternalClrAssemblies: List<DotNetClrClasspathAssembly.WithoutCarrier>
    get() = get(DotNetBackendConfigurationKeys.EXTERNAL_CLR_ASSEMBLIES, emptyList())
    set(value) {
        put(DotNetBackendConfigurationKeys.EXTERNAL_CLR_ASSEMBLIES, value)
    }

var CompilerConfiguration.dotNetFriendPaths: List<String>
    get() = get(DotNetBackendConfigurationKeys.FRIEND_PATHS, emptyList())
    set(value) {
        put(DotNetBackendConfigurationKeys.FRIEND_PATHS, value)
    }
