...
class JvmFir2IrExtensions : Fir2IrExtensions {
    ...
    private val kotlinIrInternalPackage =
        IrExternalPackageFragmentImpl(DescriptorlessExternalPackageFragmentSymbol(), IrBuiltIns.KOTLIN_INTERNAL_IR_FQN, IrModuleFragmentImpl(ErrorModuleDescriptor))

    private val kotlinJvmInternalPackage =
        IrExternalPackageFragmentImpl(DescriptorlessExternalPackageFragmentSymbol(), JvmAnnotationNames.KOTLIN_JVM_INTERNAL, IrModuleFragmentImpl(ErrorModuleDescriptor))
