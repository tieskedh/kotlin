...
fun main(args: Array<String>) {
    ...
    val removedArgumentsLevel = KotlinCompilerArgumentsLevel(
        name = CompilerArgumentsLevelNames.removedCompilerArguments,
...
val levelToClassNameMap = listOf(
    ArgumentsInfo(
        levelName = CompilerArgumentsLevelNames.removedCompilerArguments,
...
private fun SmartPrinter.generateArgumentsClass(
    ...
    val generateAlreadyRemovedArguments = info.levelName == CompilerArgumentsLevelNames.removedCompilerArguments
...
private fun KotlinCompilerArgumentsLevel.collectImports(info: ArgumentsInfo): List<String> {
    val rawImports = buildSet {
        ...
        if ((info.levelIsFinal || info.isCommonCompilerArgs) && info.levelName != CompilerArgumentsLevelNames.removedCompilerArguments) {
