...
fun box(): String {
    ...
    val visibility2 = syntheticClassVisibility(createAnn())
    if (visibility2 != LOCAL_VISIBILITY) {
        return "Fail: expected LOCAL visibility (5), got $visibility2"
    }
    ...
    val visibility3 = syntheticClassVisibility(privateCreateAnn())
    if (visibility3 != LOCAL_VISIBILITY) {
        return "Fail: expected LOCAL visibility (5), got $visibility3"
    }
