 ...
 * symbol provider.
 *
 * An extension that no [FileType][com.intellij.openapi.fileTypes.FileType] is registered for (such as `.tasty` without the Scala plugin)
 * resolves to the binary [UnknownFileType][com.intellij.openapi.fileTypes.UnknownFileType], so it is admitted as well.
 */
