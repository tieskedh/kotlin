 ...
 * platform-agnostic [org.jetbrains.kotlin.descriptors.DescriptorVisibilities] does not know about. Registered via
 * `META-INF/services` so the core can find it on the JVM classpath.
 */
